$(function(){
	...
	$.ajax({
            url: url + "logQD/signin/zcsign/query",
	...
	function page_init(index) {
       if($('.btn_orange').hasClass("btn_select")){
          ...
          $.ajax({
                 url:url + "logQD/signin/zcsign/query",
                type:"get",
                data:{"page_index": index+1,"page_size": 12,'aaa011_x':country1.val(),
                'aaa011_z':township1.val(),'aaa011_c':village1.val(),'helpTime':time1},
                beforeSend:function(request){
			          request.setRequestHeader("Authorization",token);
			          request.setRequestHeader("X-Requested-With","XMLHttpRequest");
			    },
        	...
        	var time2 = data2.val().replace(/-/g,"");
             $.ajax({
                url:url + "logQD/signin/bfsign/query",
                type:"get",
                data:{"page_index": index+1,"page_size": 12,'aaa011_x':country2.val(),
                'aaa011_z':township2.val(),'aaa011_c':village2.val(),'helpTime':time2},
                beforeSend:function(request){
			          request.setRequestHeader("Authorization",token);
			          request.setRequestHeader("X-Requested-With","XMLHttpRequest");
			    },
...
$("body").on("click",".btn_select",function(){
    var time1 = data1.val().replace(/-/g,"");
       ...
       $(function(){
        $.ajax({
            url: url + "logQD/signin/zcsign/query",
            data:{"page_index": 1,"page_size": 12,'aaa011_x':country1.val(),
                'aaa011_z':township1.val(),'aaa011_c':village1.val(),'helpTime':time1},
            beforeSend:function(request){
		          request.setRequestHeader("Authorization",token);
		          request.setRequestHeader("X-Requested-With","XMLHttpRequest");
...
$("body").on("click",".dataImport1",function(){
	$.ajax({
        url: url + "logQDExport/excel/zcsignEx/check",
        data:{},
        beforeSend:function(request){
            request.setRequestHeader("Authorization",token);
            request.setRequestHeader("X-Requested-With","XMLHttpRequest");
            ...
            function pinjie(obj){
                for(let key in obj){
                    strs+=key+"="+obj[key]+"&";
						...
						console.log(b);
						let cc=url+"logQDExport/zcsignEx?"+b;
						console.log(cc);
...
$("body").on("click",".btn_select1",function(){
    var time2 = data2.val().replace(/-/g,"");
       ...
       $(function(){
        $.ajax({
            url: url + "logQD/signin/bfsign/query",
            data:{"page_index":1,"page_size": 12,'aaa011_x':country2.val(),
                'aaa011_z':township2.val(),'aaa011_c':village2.val(),'helpTime':time2},
            beforeSend:function(request){
		          request.setRequestHeader("Authorization",token);
		          request.setRequestHeader("X-Requested-With","XMLHttpRequest");
...
$("body").on("click",".dataImport2",function(){
	$.ajax({
        url: url + "logQDExport/excel/bfsignEx/check",
        data:{},
        beforeSend:function(request){
            request.setRequestHeader("Authorization",token);
            request.setRequestHeader("X-Requested-With","XMLHttpRequest");
        ...
        if (data.code == 2000){
			var time2 = data2.val().replace(/-/g,"");
			data = {"page_index":1,"page_size": 12,'aaa011_x':country2.val(),'aaa011_z':township2.val(),'aaa011_c':village2.val(),'helpTime':time2}
            ...
            function pinjie(obj){
                for(let key in obj){
                    strs+=key+"="+obj[key]+"&";
						...
						let b=a.substring(0,a.length-1);
						console.log(b);
						let cc=url+"logQDExport/bfsignEx?"+b;
						console.log(cc);
			      window.location.href=cc;
     		}else if(data.code==1005){
			alert(data.message)
