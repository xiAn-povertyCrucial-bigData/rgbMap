    ...
    $('#year').html(year1+'年');
        ...
        //村编号 和年份
         $(function(){
              ...
              $.ajax({
                    url: url + "table/pkh/detail/update/base",
...
//家庭成员 信息
    function homeInfo(){
        ...
        $.ajax({
            url: url + "table/pkh/detail/update/family",
            data:{"aac001": theRequest.value,"aar040": year},
            beforeSend:function(request){
                          request.setRequestHeader("Authorization",token);
                          request.setRequestHeader("X-Requested-With","XMLHttpRequest");
   ...
   var str=`
       ...
       for(let i = 0; i < data.data.length; i++){
            ...
            <tr>
                ...
                <td><input class="input2" type="text" placeholder="请输入" style="border: none;text-align:center;width:100px;"/></td>
                ...
                <td><input class="input3" type="text" placeholder="请输入" style="border: none;text-align:center;width:160px;"/></td>
...
//收入
    function getIncomeInfo(){
        ...
        $.ajax({
            url: url + "table/pkh/detail/update/income",
            data:{"aac001": theRequest.value,"aar040": year},
            beforeSend:function(request){
                  request.setRequestHeader("Authorization",token);
                  request.setRequestHeader("X-Requested-With","XMLHttpRequest");
   ...
   function  showIncomeInfo(obj,data){
     ...
     data.data.AAC086,data.data.AAC087,data.data.AAC073,data.data.AAC083,
...
////生产生活信息请求
  function getLifeProductInfo() {
              var lifeProduct = $('#lifeProduct')
                $.ajax({
                    url: url + "table/pkh/detail/update/life",
                    data:{"aac001": theRequest.value,"aar040": year},
                    beforeSend:function(request){
                          request.setRequestHeader("Authorization",token);
                          request.setRequestHeader("X-Requested-With","XMLHttpRequest");
...
//上午务工信息请求
  function getLastWorkInfo() {
              var lastWork = $('#lastWork')
                $.ajax({
                    url: url + "table/pkh/detail/update/lnwginfo",
                    data:{"aac001": theRequest.value,"aar040": year},
                    beforeSend:function(request){
                          request.setRequestHeader("Authorization",token);
                          request.setRequestHeader("X-Requested-With","XMLHttpRequest");
...
//搬迁
  function getMoveInfo() {
              var banqian = $('#banqian')
                $.ajax({
                    url: url + "table/pkh/detail/update/relocate",
                    data:{"aac001": theRequest.value,"aar040": year},
                    beforeSend:function(request){
                          request.setRequestHeader("Authorization",token);
                          request.setRequestHeader("X-Requested-With","XMLHttpRequest");
...
//帮扶对接
  function getHelpInfo() {
              var helper = $('#helper')
                $.ajax({
                    url: url + "table/pkh/detail/update/help",
                    data:{"aac001": theRequest.value,"aar040": year},
                    beforeSend:function(request){
                          request.setRequestHeader("Authorization",token);
                          request.setRequestHeader("X-Requested-With","XMLHttpRequest");
...
//     }
        function reviseBasic(){
            ...
            $.ajax({
                url:url+"table/pkh/update/basic",
                method:"post",
                dataType:"json",
                data:data,
                beforeSend:function(request){
        ...
        function reviseFamily(){
         ...
         for(let i = 0; i < $(".input1").length; i++){
            sub[i]={"aac001": theRequest.value,"aar040": year,'aab001':namecode[i],
                "aab015":$(".select14").eq(i).val(),"aab002":$(".input2").eq(i).val(),
            ...
            $.ajax({
                url:url+"table/pkh/update/famliy",
                method:"post",
                dataType:"json",
                async:false,
        ...
        function reviseIncome(){
            ...
            $.ajax({
                url:url+"table/pkh/update/income",
                method:"post",
                dataType:"json",
                async:false,
                data:data,
        ...
        function reviseRelocate(){
            ...
            var  data={"aac001": theRequest.value,"aar040": year,
                ...
                $.ajax({
                    url:url+"table/pkh/update/relocate",
                    method:"post",
                    dataType:"json",
                    async:false,
                    data:data,
