$(document).ready(function(){
    var url=config.url;  /*县生态扶贫达标情况统计*/
    var year=config.year;
    let countyName=countryName;
    $(".fpCounty").html(countyName);
    $("#contyName").text(countyName);
    $("#countryname").text(countyName)
    $("#countryname2").text(countyName)
    var disctId = '';
    $.ajax({
    ...
    function industryPoverty2(){
       ...
       // let name2=countyName+"各镇（街）生态扶贫达标情况"
        $.ajax({
