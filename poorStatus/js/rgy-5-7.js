...
$("body").on("click"," #c-title2",function(){
	$('#zhezhao').show();
     str1="";
     $("#content6-1-zhen").css({'opacity':'1','top':'1%'});

     var codeType =  $(this).attr("sleep");
     //alert(codeType)
   	str1 = `
    <h3 class="c-title">周至县各镇街贫困村七项退出指标达标情况统计<span id="content-6zhen-close" class="content-6zhen-close" style="float:right;color: white;padding-right: 10px;">X</span>
...
$("body").on("click",'#table111 tr',function(){
	 $('#cunreason1').html('');
...
//////////////
$("#c-title2").click(function(){
    	$('#zhezhao').show();
		$(".content-6-1").css({"opacity":1,'top':'50%'});
